...
def csv_to_nod(path_csv,path_nod,path_pkl,journal_attribute,year_list):
    ...
    for journal in journals_dict.keys(): 
        for year in journals_dict[journal].keys():
            journals_dict[journal][year]['author_list'] = dict(Counter(journals_dict[journalname][year]['author_list']).most_common())
            journals_dict[journal][year]['keyword_plus_stat'] = dict(Counter(journals_dict[journalname][year]['keyword_plus_stat']).most_common())
            journals_dict[journal][year]['keyword_stat'] = dict(Counter(journals_dict[journalname][year]['keyword_stat']).most_common())    
...
if __name__ == '__main__':  
    ...
    path_pkl = 'D:/bigdatahw/dissertation/pre_defence/pkl/journal_dict.pkl'
