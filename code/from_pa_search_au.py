# -*- coding: utf-8 -*-
"""
Created on Sun May  5 20:51:04 2019
...
def csv_to_nod(path_csv,path_nod,path_pkl,candid_list):
    ...
    for csvname in csvnames:
        ...
        with open(filepath,mode='r',encoding='ISO-8859-1',newline='') as csv_file:
            ...
            for one_line in csv_reader_lines: 
                ...
                if one_authors.time_transform()>='2014-00' and one_authors.title in candid_list:     #加入文档去重
...
#        paper_all.extend(paper_title)
    ...
    for key,value in author_dict.items(): 
        ...
        with open(path_nod+'/author_nod3.csv', "a", newline='') as f:
            writer = csv.writer(f)
...
if __name__ == '__main__':  
    ...
    path_author_pkl = 'D:/bigdatahw/dissertation/pre_defence/pkl/author_dict_3.pkl'
    path_paper_pkl = 'D:/bigdatahw/dissertation/pre_defence/pkl/subnet_cluster.pkl'    
    subnet_cluster = read_pkl(path_paper_pkl)
    subnet3 = subnet_cluster['subnet_2']
    candid_list = list(subnet3.keys())
#    csv_to_nod(path_csv,path_nod)
    csv_to_nod(path_csv,path_nod,path_author_pkl,candid_list)
